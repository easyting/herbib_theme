...
<table style="border-collapse: collapse" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td style="border-collapse: collapse; background-color: #a94598;" height="8" width="600" bgcolor="#a94598"><br /></td>
    </tr>
    <tr>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style="border-collapse: collapse;" width="540" align="left">
                        <h1 style="margin-bottom: 20px; font-size: 34px; font-weight: bold; line-height: 36px; margin-top: 0; font-family: Helvetica, Arial, sans-serif; color: #000000 !important; letter-spacing: -1px">
...
<table style="border-collapse: collapse;" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td style="border-collapse: collapse; background-color: #178498;" height="8" width="600" bgcolor="#178498"><br /></td>
    </tr>
    <tr>
      <td style="border-collapse: collapse;" height="8" width="600" bgcolor="#ffffff"><br /></td>
    </tr>
                ...
                <table style="border-collapse: collapse;" border="0" cellpadding="0" cellspacing="0">
                  <tbody>
                    ...
                    <tr>
                      <td style="border-collapse: collapse;" width="30"><br /></td>
                      <td style="border-collapse: collapse;" width="540" align="left">
                        <h1 style="margin-bottom: 20px; margin-left: 160px; font-size: 34px; font-weight: bold; line-height: 36px; margin-top: 0; font-family: Helvetica, Arial, sans-serif; color: #000000 !important; letter-spacing: -1px;">Nyheder</h1>
                                        ...
                                        <tr>
                                          ...
                                          <td valign="top" align="left">
                                            <?php if (!empty($newsletter_node->category)): ?>
                                              <span style="background-color: #53514b; color: #ffffff; font-size: 11px; text-transform: uppercase; padding: 0 4px; text-decoration: none; font-family: Helvetica, Arial, sans-serif;">
                                                <a href="<?php echo $newsletter_node->category_url; ?>" style="color: #ffffff; text-decoration: none;"><?php echo $newsletter_node->category ?></a>
                                              </span>
                                            <?php endif; ?>
                                            <h2 style="margin-bottom: 10px; font-size: 28px; font-weight: bold; line-height: 36px; margin-top: 0; font-family: Helvetica, Arial, sans-serif; color: #000000 !important; letter-spacing: -1px;">
...
<table style="border-collapse: collapse;" border="0" cellpadding="0" cellspacing="0">
  <tbody>
    <tr>
      <td style="border-collapse: collapse; background-color: #85a0c3;" height="8" width="600" bgcolor="#85a0c3"><br /></td>
    </tr>
    <tr>
      <td style="border-collapse: collapse;" height="8" width="600" bgcolor="#ffffff"><br /></td>
    </tr>
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td valign="top" align="left">
                                          ...
                                          <?php endif; ?>
                                          <h2 style="margin-bottom: 0; font-size: 28px; font-weight: bold; line-height: 36px; margin-top: 0; font-family: Helvetica, Arial, sans-serif; color: #000000 !important; letter-spacing: -1px">
                                            <a href="<?php echo $newsletter_node->url; ?>" style="color:#000000 !important; text-decoration: none;">
                                              <?php echo $newsletter_node->title; ?>
                                            </a>
                                          </h2>
