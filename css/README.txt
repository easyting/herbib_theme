...
To use these stylesheets, rename the files and herbib_theme with the name of your theme.
...
herbib_theme-alpha-default.css
...
herbib_theme-alpha-default-narrow.css  
...
herbib_theme-alpha-default-normal.css
...
herbib_theme-alpha-default-wide.css
